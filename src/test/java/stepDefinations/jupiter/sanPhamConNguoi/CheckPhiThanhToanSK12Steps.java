            ...
            if (!(GlobalConstants.khongApDung.equals((String) SK12Value.get("Phí chuẩn Chi phí y tế điều trị tai nạn, ốm đau bệnh tật")))) {
                ...
                if (SK12Value.get("Execute").equals("RUN")) {
                    ...
                    if ((verify.verifyEquals(mucTrachnhiemQLBHChinhExpected, mucTrachNhiemQLBHChinhUI)) &&
                        ...
                        System.out.println("mucTrachNhiemQLBHChinhUI " + mucTrachNhiemQLBHChinhUI);
                        System.out.println("mucTrachNhiemQLBHChinhExpected " + mucTrachnhiemQLBHChinhExpected);

                        spreadsheet.addNoteToCell(row - 1, row, 28, 29, 0, phiChuanQLBHChinhUI, GlobalConstants.sheetSK12ID);
                        System.out.println("phiChuanQLBHChinhUI " + phiChuanQLBHChinhUI);
                        System.out.println("phiChuanQLBHChinhExpected " + phiChuanQLBHChinhExpected);

                        spreadsheet.addNoteToCell(row - 1, row, 35, 36, 0, phiThanhToanQLBHChinhUI, GlobalConstants.sheetSK12ID);
                        System.out.println("phiThanhToanQLBHChinhUI " + phiThanhToanQLBHChinhUI);
                        System.out.println("phiThanhToanQLBHChinhExpected " + phiThanhToanQLBHChinhExpected);

                        spreadsheet.addNoteToCell(row - 1, row, 21, 22, 0, mucTrachNhiemDieuTriNgoaiTruUI, GlobalConstants.sheetSK12ID);
                        System.out.println("mucTrachNhiemDieuTriNgoaiTruUI " + mucTrachNhiemDieuTriNgoaiTruUI);
                        System.out.println("mucTrachNhiemDieuTriNgoaiTruExpected " + mucTrachNhiemDieuTriNgoaiTruExpected);

                        spreadsheet.addNoteToCell(row - 1, row, 29, 30, 0, phiChuanDieuTriNgoaiTruUI, GlobalConstants.sheetSK12ID);
                        System.out.println("phiChuanDieuTriNgoaiTruUI " + phiChuanDieuTriNgoaiTruUI);
                        System.out.println("phiChuanDieuTriNgoaiTruExpected " + phiChuanDieuTriNgoaiTruExpected);

                        spreadsheet.addNoteToCell(row - 1, row, 36, 37, 0, phiThanhToanDieuTriNgoaiTruUI, GlobalConstants.sheetSK12ID);
                        System.out.println("phiThanhToanDieuTriNgoaiTruUI " + phiThanhToanDieuTriNgoaiTruUI);
                        System.out.println("phiThanhToanDieuTriNgoaiTruExpected " + phiThanhToanDieuTriNgoaiTruExpected);


                        spreadsheet.addNoteToCell(row - 1, row, 22, 23, 0, mucTrachNhiemDieuTriNhaKhoaUI, GlobalConstants.sheetSK12ID);
                        System.out.println("mucTrachNhiemDieuTriNhaKhoaUI" + mucTrachNhiemDieuTriNhaKhoaUI);
                        System.out.println("mucTrachNhiemDieuTriNhaKhoaExpected" + mucTrachNhiemDieuTriNhaKhoaExpected);

                        spreadsheet.addNoteToCell(row - 1, row, 30, 31, 0, phiChuanDieuTriNhaKhoaUI, GlobalConstants.sheetSK12ID);
                        System.out.println("phiChuanDieuTriNhaKhoaUI" + phiChuanDieuTriNhaKhoaUI);
                        System.out.println("phiChuanDieuTriNhaKhoaExpected" + phiChuanDieuTriNhaKhoaExpected);

                        spreadsheet.addNoteToCell(row - 1, row, 37, 38, 0, phiThanhToanDieuTriNhaKhoaUI, GlobalConstants.sheetSK12ID);
                        System.out.println("phiThanhToanDieuTriNhaKhoaUI" + phiThanhToanDieuTriNhaKhoaUI);
                        System.out.println("phiThanhToanDieuTriNhaKhoaExpected" + phiThanhToanDieuTriNhaKhoaExpected);
                    }
